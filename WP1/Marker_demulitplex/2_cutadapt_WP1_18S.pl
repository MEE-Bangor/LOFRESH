...
system("cutadapt -g GTCGGTAAAACTCGTGCCAGC -a CATAGTGGGGTATCTAATCCCAGTTTG -e=0.2 --discard-untrimmed -o $outdir/$cutout1 -p $outdir/$cutout2 $indir/$read1 $indir/$read2");
