...
miseq_path <- "/nfshome/store02/users/b.bsp81d/Lofresh_raw_data/WP1/Davies_metabarcoding_CO1"
...
filt_path <- "/nfshome/store02/users/b.bsp81d/Lofresh_raw_data/WP1/Davies_metabarcoding_CO1/filtered"
...
write.table(taxTab,"taxTab_WP1_CO1.txt")				 
write.table(seqtabNoC,"seqtabNoC_WP1_CO1.txt")
