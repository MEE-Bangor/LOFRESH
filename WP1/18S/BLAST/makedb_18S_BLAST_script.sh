...
makeblastdb -in /nfshome/store02/users/b.bsp81d/Lofresh_raw_data/WP1/Davies_metabarcoding_analysis/18S_BLAST/18S_rRNA.fasta -out /nfshome/store02/users/b.bsp81d/Lofresh_raw_data/WP1/Davies_metabarcoding_analysis/18S_BLAST/18S_local_BLASTdb -dbtype nucl -parse_seqids -taxid_map /nfshome/store02/users/b.bsp81d/Lofresh_raw_data/WP1/Davies_metabarcoding_analysis/18S_BLAST/nucl_gb.accession2taxid -blastdb_version 5 